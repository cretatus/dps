...
INSERT INTO `application` VALUES (1,'test','',1),(8,'qqq','test_q1q',1),(9,'test2','',1);
...
INSERT INTO `assembly_has_version` VALUES (1,7),(2,9);
...
INSERT INTO `build` VALUES (1,8,1,'2019-07-07 00:00:00.000000',0,NULL),(2,8,1,'2019-07-07 16:35:04.234000',1,NULL),(3,8,1,'2019-07-07 16:36:26.466000',2,NULL),(4,8,1,'2019-07-07 16:43:51.556000',3,NULL),(5,8,1,'2019-07-07 16:45:26.356000',4,NULL),(6,8,1,'2019-07-07 16:47:04.094000',5,NULL),(7,8,1,'2019-07-07 16:58:41.570000',6,NULL),(8,8,1,'2019-07-07 17:00:38.498000',7,NULL),(9,8,1,'2019-07-08 19:46:47.097000',8,NULL),(10,8,1,'2019-07-08 19:47:52.604000',9,NULL),(11,8,1,'2019-07-08 19:52:21.248000',10,NULL),(13,8,1,'2019-07-08 20:00:39.232000',11,NULL),(17,8,2,'2019-07-09 08:55:24.634000',0,NULL);
...
CREATE TABLE `component` (
  ...
  KEY `fk_component_subtype1_idx` (`subtype_code`),
  ...
  CONSTRAINT `fk_component_subtype1` FOREIGN KEY (`subtype_code`) REFERENCES `subtype` (`code`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `dependency` VALUES (1,1,3,NULL,2);
...
CREATE TABLE `entity_key` (
  ...
  CONSTRAINT `fk_entity_key_subtype1` FOREIGN KEY (`subtype_code`) REFERENCES `subtype` (`code`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `generator` VALUES (2,1,3,'222','222',NULL,3,2,0),(3,1,2,'test','test',NULL,6,2,0),(7,8,9,'asdf','asdf',NULL,38,4,16);
...
CREATE TABLE `job` (
  ...
  `description` varchar(2000) DEFAULT NULL,
  `parameter_structure_id` int(11) NOT NULL,
  `output_stream_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_language_application1_idx` (`application_id`),
  KEY `fk_job_structure1_idx` (`parameter_structure_id`),
  KEY `fk_job_stream1_idx` (`output_stream_id`),
  KEY `fk_job_version1_idx` (`version_id`),
  KEY `fk_job_category1_idx` (`category_id`),
  CONSTRAINT `fk_job_category1` FOREIGN KEY (`category_id`) REFERENCES `stereotype` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_job_stream1` FOREIGN KEY (`output_stream_id`) REFERENCES `stream` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_language_application100` FOREIGN KEY (`application_id`) REFERENCES `application` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `listener` (
  ...
  `key_structure_id` int(11) NOT NULL,
  `value_structure_id` int(11) NOT NULL,
  `job_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_listener_application1_idx` (`application_id`),
  KEY `fk_listener_function1_idx` (`process_function_id`),
  KEY `fk_listener_structure1_idx` (`key_structure_id`),
  KEY `fk_listener_structure2_idx` (`value_structure_id`),
  KEY `fk_listener_job1_idx` (`job_id`),
  KEY `fk_listener_version1_idx` (`version_id`),
  KEY `fk_listener_category1_idx` (`category_id`),
  ...
  CONSTRAINT `fk_listener_category1` FOREIGN KEY (`category_id`) REFERENCES `stereotype` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_listener_structure1` FOREIGN KEY (`key_structure_id`) REFERENCES `structure` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_listener_structure2` FOREIGN KEY (`value_structure_id`) REFERENCES `structure` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `operation` (
  ...
  KEY `fk_operation_category1_idx` (`category_id`),
  CONSTRAINT `fk_language_application1000` FOREIGN KEY (`application_id`) REFERENCES `application` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_operation_category1` FOREIGN KEY (`category_id`) REFERENCES `stereotype` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `sender` (
  ...
  KEY `fk_sender_stream1_idx` (`stream_id`),
  KEY `fk_sender_version1_idx` (`version_id`),
  KEY `fk_sender_category1_idx` (`category_id`),
  CONSTRAINT `fk_language_application1011` FOREIGN KEY (`application_id`) REFERENCES `application` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_reader_operation11` FOREIGN KEY (`operation_id`) REFERENCES `operation` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_sender_category1` FOREIGN KEY (`category_id`) REFERENCES `stereotype` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_sender_stream1` FOREIGN KEY (`stream_id`) REFERENCES `stream` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_sender_version1` FOREIGN KEY (`version_id`) REFERENCES `version` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sender_has_tag` (
  ...
  CONSTRAINT `fk_sender_has_tag_sender1` FOREIGN KEY (`sender_id`) REFERENCES `sender` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `sequence` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_language_application1_idx` (`application_id`),
  KEY `fk_reader_operation1_idx` (`from_operation_id`),
  ...
  KEY `fk_sequence_category1_idx` (`category_id`),
  CONSTRAINT `fk_language_application10100` FOREIGN KEY (`application_id`) REFERENCES `application` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_reader_operation100` FOREIGN KEY (`from_operation_id`) REFERENCES `operation` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_sequence_category1` FOREIGN KEY (`category_id`) REFERENCES `stereotype` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_writer_version10` FOREIGN KEY (`version_id`) REFERENCES `version` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stereotype` (
  ...
  KEY `fk_stereotype_subtype1_idx` (`subtype_code`),
  ...
  CONSTRAINT `fk_stereotype_subtype1` FOREIGN KEY (`subtype_code`) REFERENCES `subtype` (`code`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `stream` (
  ...
  `sysname` varchar(45) NOT NULL,
  `description` varchar(2000) DEFAULT NULL,
  `glossary_url` varchar(2000) DEFAULT NULL,
  `structure_id` int(11) NOT NULL,
  `catche_entity_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_stream_structure1_idx` (`structure_id`),
  ...
  CONSTRAINT `fk_stream_category1` FOREIGN KEY (`category_id`) REFERENCES `stereotype` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_stream_entity1` FOREIGN KEY (`catche_entity_id`) REFERENCES `entity` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_stream_structure1` FOREIGN KEY (`structure_id`) REFERENCES `structure` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `subscribtion` (
  ...
  CONSTRAINT `fk_subscribtion_category1` FOREIGN KEY (`category_id`) REFERENCES `stereotype` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_subscribtion_function2` FOREIGN KEY (`process_function_id`) REFERENCES `function` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_subscribtion_listener1` FOREIGN KEY (`listener_id`) REFERENCES `listener` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `subscribtion_has_tag` (
  ...
  CONSTRAINT `fk_subscribtion_has_tag_subscribtion1` FOREIGN KEY (`subscribtion_id`) REFERENCES `subscribtion` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `subtype` VALUES ('area','Area'),('attribute','Attribute'),('element','Element'),('entity','AppEntity'),('entity structure','Structure'),('generator','Generator'),('index','Key'),('key structure','Structure'),('pk','Key'),('simple structure','Structure'),('uq','Key');
...
-- Dump completed on 2019-07-10 13:42:26
