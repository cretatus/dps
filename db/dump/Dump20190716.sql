...
INSERT INTO `invitation` VALUES (2,8,'accepted','admin','wasilij_@mail.ru',NULL,NULL,1);
...
CREATE TABLE `user` (
  ...
  `current_permission` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `user` VALUES (1,'Admin','admin','admin','vasiliy.kuzmin@gmail.com',NULL,9,'owner'),(4,'ccccccc','ccccccc','load1979','vasiliy.kuzmin1@gmail.com',NULL,NULL,NULL),(5,'wasilij','wasilij','1234','wasilij_@mail.ru',8,NULL,NULL);
...
-- Dump completed on 2019-07-16 19:08:25
